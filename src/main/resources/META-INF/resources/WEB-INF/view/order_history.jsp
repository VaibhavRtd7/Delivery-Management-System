  ...
  <tbody>
    <c:forEach items="${orders}" var="order">
      <tr>
        ...
        <td class="text-center"><a href="<%=request.getContextPath()%>/deliveryPerson/accept/order/${order.id}" onclick="return confirm('Do you really want to accept this order?')"><i class="fas fa-check"></i></a></td>
      </tr>
    </c:forEach>
  </tbody>
</table>
